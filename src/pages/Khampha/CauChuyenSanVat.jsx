...
function CauChuyenSanVat() {
    ...
    const getImageUrl = (hinhanh) => {
        ...
        return `${storageUrl}${separator}${imagePath}`;
    };
                        ...
                        >
                            <div className="blog-feat-img-wrapper">
                                <img
                                    ...
                                    src={randomBlogs[0].hinhanh ? getImageUrl(randomBlogs[0].hinhanh) : 'https://via.placeholder.com/800x450?text=San+Vat+Mien+Tay'}
                            ...
                            {randomBlogs.slice(1, 5).map((blog) => (
                                ...
                                >
                                    <img
                                        ...
                                        src={blog.hinhanh ? getImageUrl(blog.hinhanh) : 'https://via.placeholder.com/150?text=San+Vat'}
                                        alt={blog.tittel}
                                    />
                    ...
                    <div className="blogs-grid">
                        ...
                        >
                            <div className="blog-feat-img-wrapper">
                                <img
                                    className="blog-feat-img"
                                    src={tinTucList[0].hinhanh ? getImageUrl(tinTucList[0].hinhanh) : 'https://via.placeholder.com/800x450?text=Tin+Tuc+Mien+Tay'}
                        ...
                        <div className="blogs-side-list">
                            {tinTucList.slice(1, 5).map((news) => (
                                ...
                                >
                                    <img
                                        className="blog-simple-img"
                                        src={news.hinhanh ? getImageUrl(news.hinhanh) : 'https://via.placeholder.com/150?text=San+Vat'}
                                        alt={news.tittel}
                                    />
                                    <div className="blog-simple-content">
                                        <div className="blog-meta" style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
